...
public interface IDBServices {
    ...
    void modifyDiscipline(String id, String newName) throws SQLException;

    void deleteDiscipline(String id) throws SQLException;
    ...
    void modifyTerm(String idTerm, String newDuration, String newIdsDisc);
